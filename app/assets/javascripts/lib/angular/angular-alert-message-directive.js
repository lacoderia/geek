...
Geek.directive('ngAlertMessage', ["$rootScope", function($rootScope){
    return{
        ...
        replace: true,
        transclude: false,
        template:   '<span ng-class="[ALERT_VALUES[alertParams.type].alertClass,modal-alert-message]" ng-style="alertStyle"><span ng-class="[ALERT_VALUES[alertParams.type].alertIcon]"></span> {{ alertParams.message | translate }}</span>',
