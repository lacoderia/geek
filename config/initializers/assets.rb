...
Rails.application.config.assets.precompile += %w( student/services/forgotService.js )
...
Rails.application.config.assets.precompile += %w( student/controllers/tutorProfileCtrl.js )
...
Rails.application.config.assets.precompile += %w( tutor/services/forgotService.js )
...
Rails.application.config.assets.precompile += %w( lib/angulartics.js )
Rails.application.config.assets.precompile += %w( lib/angulartics-mixpanel.js )
...
Rails.application.config.assets.precompile += %w( student/controllers/faqCtrl.js )
